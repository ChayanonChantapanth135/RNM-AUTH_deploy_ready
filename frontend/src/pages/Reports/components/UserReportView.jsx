    ...
    return (
      ...
      >
        ...
        <p
          ...
          style={{ color: data.color || data.payload?.fill }}
        >
          <span>{data.name}:</span>
...
export default function UserReportView({ data }) {
  ...
  const formatTaskType = (type) => {
    ...
    if (type === "แปล" || type === "Translate")
      return t("taskTypeTranslate") || "Translate";
    if (type === "สตอรี่บอร์ด" || type === "Storyboard & Script")
      return t("taskTypeStoryboard") || "Storyboard & Script";
    if (type === "ออกแบบ" || type === "Graphic & Design")
      return t("taskTypeGraphicDesign") || "Graphic & Design";
    if (type === "อนิเมชัน" || type === "Animation")
      return t("taskTypeAnimation") || "Animation";
    if (type === "ตัดต่อ" || type === "Video Editing" || type === "Video Edit")
      return t("taskTypeVideoEdit") || "Video Edit";
    if (type === "พัฒนาโปรแกรม" || type === "Development")
      return t("taskTypeDevelopment") || "Development";
    if (type === "อื่นๆ" || type === "Others")
      return t("taskTypeOthers") || "Others";
    return type;
  };
    ...
    if (typeFilter !== "all") {
      result = result.filter((task) => {
        const type = (task.taskType || task.task_type || "")
          .toLowerCase()
          .trim();
        if (typeFilter === "translate")
          return type === "แปล" || type.includes("translate");
        if (typeFilter === "storyboard")
          return (
            type === "สตอรี่บอร์ด" ||
            type.includes("storyboard") ||
            type.includes("script") ||
            type === "บท"
          );
        if (typeFilter === "graphicDesign")
          return (
            type === "ออกแบบ" ||
        ...
        if (typeFilter === "others")
          return type === "อื่นๆ" || type.includes("other");
        return true;
      });
    }
          ...
          <div className="h-64 w-full mt-2">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={[
                  {
                    name: t("taskTypeTranslate") || "แปล",
                    count: myTaskTypeCounts.translate || 0,
                    fill: "#2dd4bf",
                  },
                  {
                    name: t("taskTypeStoryboard") || "สตอรี่บอร์ด",
                    count: myTaskTypeCounts.storyboard || 0,
                    fill: "#f59e0b",
                  },
                  {
                    name: t("taskTypeGraphicDesign") || "ออกแบบ",
                    count: myTaskTypeCounts.graphicDesign || 0,
                    fill: "#ec4899",
                  },
                  {
                    name: t("taskTypeAnimation") || "อนิเมชัน",
                    count: myTaskTypeCounts.animation || 0,
                    fill: "#06b6d4",
                  },
                  {
                    name: t("taskTypeVideoEdit") || "ตัดต่อ",
                    count: myTaskTypeCounts.videoEdit || 0,
                    fill: "#818cf8",
                  },
                  {
                    name: t("taskTypeDevelopment") || "โปรแกรม",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 items-center">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <option value="all">
                    {t("allTaskTypes") || "ทุกประเภทงาน"}
                  </option>
                  <option value="translate">
                    {t("taskTypeTranslate") || "แปล"}
                  </option>
                  <option value="storyboard">
                    {t("taskTypeStoryboard") || "สตอรี่บอร์ด"}
                  </option>
                  <option value="graphicDesign">
                    {t("taskTypeGraphicDesign") || "ออกแบบ"}
                  </option>
                  <option value="animation">
                    {t("taskTypeAnimation") || "อนิเมชัน"}
                  </option>
                  <option value="videoEdit">
                    {t("taskTypeVideoEdit") || "ตัดต่อ"}
                  </option>
                  <option value="development">
                    {t("taskTypeDevelopment") || "พัฒนาโปรแกรม"}
                  </option>
                  <option value="others">
