    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        ...
        <div className="relative">
          ...
          >
            <option value="all">{t("allActivities") || "All Activities"}</option>
            <option value="project">{t("aboutProjects") || "Projects"}</option>
            <option value="user">{t("aboutUsers") || "Users"}</option>
            <option value="system">{t("aboutSystem") || "System"}</option>
          </select>
